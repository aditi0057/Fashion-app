  ...
  return (
    <div className="rewards-page">
      ...
      <header className="bg-cover bg-center h-screen flex items-center justify-center bg-gradient-to-r from-purple-500 to-indigo-500">
        <h1 className="text-5xl font-extrabold text-white drop-shadow-lg">Earn Rewards with Outfit Streaks!</h1>
      </header>
      ...
      <section className="rewards-system py-16 bg-gray-50 text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold mb-12">Rewards Points System</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="point-item p-6 bg-white rounded-lg shadow-md">
      ...
      <section className="redeem-points py-16 text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold mb-12">Redeem Your Points</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="reward-item p-8 bg-white rounded-lg shadow-md">
